...
iot@attackdefense:~/embedded-linux/Step-6/userspace_programs$ cat hello 
hello.s       helloworld.c  
iot@attackdefense:~/embedded-linux/Step-6/userspace_programs$ cat hello
hello.s       helloworld.c  
iot@attackdefense:~/embedded-linux/Step-6/userspace_programs$ cat helloworld.c 
#include<stdio.h>
